...
//	int	(*geti)(struct mount *mnt, int inode_num, struct vnode *vn);
//	int	(*puti)(struct mount *mnt, int inode_num, struct vnode *vn);
	...
	int	(*mount)(struct vnode *vn, struct mount *mount, const char *ops);
